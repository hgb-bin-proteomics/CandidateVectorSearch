...
data <- read_xlsx("benchmark_pc_5000000.xlsx")
...
grp08_palette = c("#2B2D42", "#383B50", "#44485D", "#5C6378",
                  "#BDC6D1", "#D5DCE3", "#E1E7EC", "#EDF2F4")

text_col <- c(rep("white", 4), rep("black", 4))
...
ggplot(data, aes(x = Method, y = Mean, fill = Method)) +
  ...
  ggtitle("Execution time of the different methods using 5 000 000 simulated candidates.") +
  xlab("Method") +
  ylab("Time (s)") +
